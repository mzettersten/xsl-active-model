...
accounted for the data, although 51\% participants appear to be driven
solely by this bias, while another 48\% apparently also engage a
competing familiarity bias. Analysis of selection strategies revealed
developmental differences: adults often used entropy maximization (39\%
of adults vs.~20\% of children) to reduce uncertainty about ambiguous
items, while children favored confirmatory sampling (62\% vs.~22\% of
adults), seeking information about items with established associations.
These findings suggest that the ability to strategically sample
ambiguous information develops gradually, and that individual
...
\begin{CodeChunk}
\begin{figure}[tb]
\includegraphics{figs/unnamed-chunk-6-1} \caption[Best-fitting selection strategies by age group]{Best-fitting selection strategies by age group.}\label{fig:unnamed-chunk-6}
\end{figure}
\end{CodeChunk}
