...
selection strategies revealed developmental differences: adults often
used an information gain strategy (39\% of adults vs.~20\% of children)
to reduce uncertainty about ambiguous items, while children favored
confirmatory sampling (62\% vs.~22\% of adults), seeking information
about items with established associations. These findings suggest that
the ability to strategically sample ambiguous information develops
gradually, and that individual differences in learning
mechanisms---particularly learning rate and memory---are more predictive
of word learning success than sampling strategy alone.
...
without indication of the correct mappings (Kachergis, Yu, \& Shiffrin,
2016; Yu \& Smith, 2007). While model comparisons in these passive
contexts are informative, active learning paradigms in which learners
control some aspect of their input (e.g., selecting which item to learn
about next) can be more diagnostic of underlying learning mechanisms and
may better capture individual differences in learning success (Gureckis
\& Markant, 2012; Markant, Settles, \& Gureckis, 2016). Yet few active
word learning experiments have been conducted, and fewer still have
attempted to explain active learning behavior with computational models
(though see Kachergis, Yu, \& Shiffrin, 2013).
...
mutual exclusivity effects in prior work (Kachergis, Yu, \& Shiffrin,
2012, 2016). Third, what sampling strategies (e.g., entropy reduction
...
uncertainty-biased associative model (Kachergis et al., 2012, 2016), and
...
choices: maximizing entropy reduction (information gain) and margin
sampling.
...
We also tested a few additional strategies. First, we also considered a
\emph{maximum certainty} (or confirmatory) strategy. Learners may
gravitate towards confirming choices they already have high certainty
for (Wason, 1960; Zettersten, Cutler, \& Lew-Williams, 2023). Second, we
...
Third, we consider a \emph{random} selection strategy as a baseline
comparison.
...
children (age\textless18) are more likely than adults to be
...
and the results are shown in Table 3. Confirmatory was the most common
strategy (42\% of participants), followed by entropy (29\%), margin
sampling (18\%), random (8\%), and novelty (3\%). Figure 4 shows the
proportion of participants by age group that are most likely to be using
each selection strategy. Adults were more likely to use entropy
maximization (39\% vs.~20\% of children), whereas children were more
likely to use a confirmatory strategy (62\% vs.~22\% of adults). Margin
sampling was used at a similar rate by children (14\%) and adults
(22\%), and a random selection was most likely for 13\% of adults, but
only 3\% of children. Novelty was the most likely strategy for only 5\%
of adults, and was not used by any children.
...
\begin{CodeChunk}
\begin{figure}[tb]
\includegraphics{figs/unnamed-chunk-6-1} \caption[Best-fitting selection strategies by age group]{Best-fitting selection strategies by age group. A higher proportion of children (vs. adults) used a confirmatory strategy, while a higher proportion of adults used an entropy-based information gain strategy.}\label{fig:unnamed-chunk-6}
\end{figure}
\end{CodeChunk}
...
et al., 2021; Nussenbaum et al., 2019). It is also consistent with other
recent work finding that children are often conservative in their
sampling strategies when learning to generalize word meanings
(Zettersten, Chen, \& Lew-Williams, 2025). Notably, these findings
contrast with evidence from other domains that children are sometimes
more exploratory than adults (Liquin \& Gopnik, 2022), highlighting that
children's tendency to engage in exploratory information-seeking varies
by context and the demands of the task (Ruggeri, Walker, Lombrozo, \&
Gopnik, 2021).

Why might children be more confirmatory in their information sampling
about novel words than adults? One possibility is that children's
limited working memory doesn't allow them to effectively evaluate
multiple competing associations per item during sampling. However, other
work suggests that children at similar ages are sensitive to the
relative informativeness of options when making active choices,
suggesting memory limitations are likely not the sole factor at play
(Zettersten, Choi, Kirkorian, \& Saffran, 2025). Another possibility is
that children's ability to engage in information-seeking that targets
uncertainty reduction develops in concert with growth in metacognitive
reasoning skills that allow them to access their own uncertainty (Baer
\& Kidd, 2022; Eccher, Mundry, \& Mani, 2024). In contrast, a
confirmatory sampling strategy can be conducted even if a learner tracks
only their strongest hypothesis.
...
http://doi.org/\href{https://doi.org/10.1016/j.tics.2022.07.010}{10.1016/j.tics.2022.07.010}
...
http://doi.org/\href{https://doi.org/10.1098/rsos.231283}{10.1098/rsos.231283}
...
\emph{218}, 104940.
http://doi.org/\href{https://doi.org/10.1016/j.cognition.2021.104940}{10.1016/j.cognition.2021.104940}
...
Psychology}, \emph{11}.
http://doi.org/\href{https://doi.org/10.3389/fpsyg.2020.586819}{10.3389/fpsyg.2020.586819}
...
conservatively when learning novel word extensions. In \emph{Proceedings
of the 47th {Annual} {Conference} of the {Cognitive} {Science}
{Society}} (pp. 1307--1313). Cognitive Science Society.
...
curriculum to past experiences} (preprint). PsyArXiv. Retrieved from
\url{https://osf.io/preprints/psyarxiv/ne43k_v1}

\bibitem[\citeproctext]{ref-zettersten_active_2023}
Zettersten, M., Cutler, M., \& Lew-Williams, C. (2023). Active
information-seeking in support of learning extensions of novel words. In
\emph{Proceedings of the 45th {Annual} {Conference} of the {Cognitive}
{Science} {Society}} (pp. 3018--3024). Cognitive Science Society.
